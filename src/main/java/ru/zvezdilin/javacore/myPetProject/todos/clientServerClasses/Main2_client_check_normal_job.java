...
public class Main2_client_check_normal_job {
    ...
    public static void main(String[] args) throws InterruptedException, BadDataException { //TODO в тесты добавить мокирование, имитирующее ответ работу client + server + База Данных PostgresQL
        ...
        logger.getInfo("редактирование перевода: " + unit);
        unit.editTranslation("ss");
        logger.getInfo("перевод после: " + unit);

        logger.getInfo("редактирование слова: " + unit);
        unit.editWord("неслово");
...
//        s= Client.makeRequestToGetAllTasks();
        ...
        String s = Client.makeRequestToAddNewWord(wordToJsonToServer);
        ...
        switch (type) {
            case "ADD":
                Language language = TodoServer.jsonToEnglishLanguage(languageInJson);
